...
const FEED_TITLE = 'softmeal.org — English';
const FEED_DESCRIPTION = 'Dysphagia and texture-modified food knowledge hub — IDDSI guides, recipes, and caregiver resources.';
