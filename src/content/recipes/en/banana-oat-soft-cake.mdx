...
- **Overripe bananas**: Supermarkets and wet markets — look for bananas with heavily blackened skins (often marked down in price); these are ideal for baking
- **Quick-cook rolled oats**: Available at all major supermarkets (look for "instant" or "quick oats", not steel-cut)
- **Baking powder**: Supermarket baking aisle
