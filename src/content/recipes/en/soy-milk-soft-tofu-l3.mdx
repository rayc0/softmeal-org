...
- **Whole soy milk**: Available at supermarkets and wet market tofu stalls. Choose full-bean (全豆) soy milk with no added flavourings — organic soy milk tends to have a richer flavour
- **Arrowroot powder**: Available at Chinese herbal medicine shops and organic food stores. Cornstarch (栗粉) can substitute but produces a slightly different texture
