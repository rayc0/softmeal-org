...
- **Silken tofu**: Supermarket chilled sections; Japanese-style "extra-silken" (特嫩) recommended
- **Dashi stock**: Supermarket Japanese foods section; instant dashi granules suitable; or use clear chicken stock as a substitute
- **Eggs**: Wet market or supermarket — fresh local eggs (本地鮮蛋) for best flavour
