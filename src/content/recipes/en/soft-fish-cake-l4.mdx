...
- **Fresh fish fillets**: Wet market fishmongers will fillet and debone on request. Grass carp (鯇魚) is the most common and economical choice; sole (龍脷) is premium. Tilapia provides a mild flavour at moderate cost.
- **Pre-minced fish paste**: Some wet market fishmongers sell pre-minced 魚滑 (fish paste) — this is a convenient shortcut; check that it contains no undesirable additives and is freshly prepared.
