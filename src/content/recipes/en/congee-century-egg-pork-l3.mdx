...
- **Century eggs**: Available at all wet markets and major supermarkets (PARKnSHOP, Wellcome); select eggs with intact shells and a clear, firm, translucent dark egg white; avoid any with cracked shells or off odour
- **Lean pork**: Wet market pork stalls — request the vendor to mince pork leg or tenderloin very finely; pre-minced pork is also available in supermarket chilled sections
- **White rice**: Jasmine rice (絲苗米) produces a smoother congee that blends more easily than short-grain varieties
