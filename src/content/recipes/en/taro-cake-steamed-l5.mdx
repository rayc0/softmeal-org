...
- **Taro**: Wet market produce stalls or PARKnSHOP / Wellcome; Lipu taro (荔浦芋頭) from Guangxi is preferred for its high starch content and fluffy texture after steaming; available year-round with peak supply around Lunar New Year
- **Rice flour**: PARKnSHOP and Wellcome stock multiple brands; choose products labelled "rice flour" or "in-coming rice flour" (在來米粉) — not glutinous rice flour (糯米粉), which produces a different texture
- **Dried shrimp**: Wet market dried goods stalls; choose small, pale-coloured dried shrimp with lower salt content; some health food sections stock reduced-sodium versions
