...
- **Unsweetened almond milk (beverage):** Alpro Almond Unsweetened, Blue Diamond Almond Breeze Unsweetened — PARKnSHOP (International section), Wellcome, City'super, ThreeSixty
- **Note on Chinese almond drink (杏仁露):** The traditional Cantonese almond drink (e.g., Vita or Sau Tao canned varieties) uses southern almond (南杏仁) and is a different product from Western almond milk. Either can be used — the flavour profile will differ, with the Chinese version having a more distinctive fragrant almond character.
- **Gelatine sheets:** PARKnSHOP and Wellcome baking sections; specialist baking supply shops
