...
medical_condition:
  ...
  treatments:
    - name: "Texture-modified diet (IDDSI Framework)"
    - name: "Speech-language therapy assessment and intervention"
    - name: "Thickener prescription"
related_articles:
  - "en/iddsi-guide"
  - "en/resources"
---
...
**Dysphagia** (swallowing difficulty) is a condition in which swallowing food or liquid becomes difficult, unsafe, or painful. It affects over **600,000 people** in Hong Kong, most commonly after stroke, Parkinson's disease, dementia, or head and neck cancer treatment. Management requires a speech-language pathologist assessment and an IDDSI-compliant modified diet.

Swallowing involves more than **50 muscles** and multiple neurological systems — when any part of this process fails, dysphagia can result. [[Source: HKSHA](https://www.hksha.org)]
