---
title: "Adapting Cultural Food Traditions for People with Dysphagia"
description: "Practical guidance for families on safely adapting culturally significant foods — including Cantonese, South Asian, Mediterranean and other cuisines — to IDDSI-compliant textures."
lang: en
...
The good news is that most culturally significant foods can be adapted to meet the requirements of the IDDSI framework ([iddsi.org/framework](https://www.iddsi.org/framework)) without losing the essence of their flavour and meaning. This article provides practical guidance for families, with specific attention to Asian cuisines, and a framework for approaching any unfamiliar cultural food with dysphagia safety in mind.
...
- **Level 7 (Regular)**: No restriction — standard food
- **Level 6 (Soft and Bite-Sized)**: Tender, moist food that breaks apart under gentle pressure; pieces no larger than 1.5 cm × 1.5 cm
- **Level 5 (Minced and Moist)**: Small soft particles, no larger than 4 mm × 4 mm; no separate liquid pooling
- **Level 4 (Puréed)**: Smooth, no lumps, no bits, no fibres; holds shape on spoon but moves slowly
- **Level 3 (Liquidised)**: Pourable but slower than water; loses shape after a few seconds
...
Understanding the [mechanism of dysphagia](/en/clinical/dysphagia-mechanism) helps families appreciate why certain textures are dangerous: it is not arbitrary, but a reflection of the specific phase of swallowing that is impaired.
