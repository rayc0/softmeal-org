---
title: "Eating with Dignity in Advanced Illness: Person-Centred Approaches to Dysphagia Care"
description: "A compassionate framework for maintaining eating dignity, pleasure and autonomy for people with dysphagia in advanced illness, including comfort feeding and sensory approaches."
lang: en
...
Understanding the [mechanism of dysphagia](/en/clinical/dysphagia-mechanism) helps carers and clinical teams appreciate what is actually happening physically, and therefore what adaptations can meaningfully preserve the eating experience even when swallowing function is severely compromised.
...
Even in a comfort feeding framework, the IDDSI framework ([iddsi.org/framework](https://www.iddsi.org/framework)) remains a useful reference — not as an absolute prescription, but as a guide to minimising unnecessary risk. Within a comfort feeding approach:
