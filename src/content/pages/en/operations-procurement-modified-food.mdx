---
title: "Procuring Texture-Modified Foods: Supplier Evaluation and Specification Verification"
description: "A practical guide for care home procurement leads on evaluating texture-modified food suppliers, verifying IDDSI compliance and writing robust product specifications."
lang: en
...
The IDDSI Framework ([iddsi.org/framework](https://www.iddsi.org/framework)) mandates that food and fluid level descriptors are determined by standardised testing methods, not by the manufacturer's marketing category alone.
...
Integrating texture testing into the [monthly audit checklist](/en/operations/audit-checklist-care-home) ensures that verification becomes routine rather than reactive.
...
Refer to [malnutrition screening protocols](/en/nutrition/malnutrition-screening) when reviewing supplement choices alongside thickener procurement — many oral nutritional supplements are available in pre-thickened formulations that simplify preparation and reduce error risk.
...
Understanding the [mechanism of dysphagia](/en/clinical/dysphagia-mechanism) reinforces why these failures matter: a product served at the wrong consistency is not a minor catering error — it is a clinical safety event.
