---
title: "Dysphagia Care Plan Documentation Standards: What Must Be Recorded and Why"
description: "A comprehensive guide to dysphagia documentation requirements for care home staff, covering mandatory care plan fields, SLT record integration and regulatory compliance."
lang: en
...
**Assessment status**:
- Date of most recent formal dysphagia assessment
- Name and registration number of the SLT or other qualified assessor
- Assessment tool used (e.g., GUSS, MASA, Mann Assessment)
- Next review date

**Texture and fluid prescription**:
- IDDSI level for food (Levels 3–7 or "regular")
- IDDSI level for fluids (Levels 0–4)
- Specific products or preparation methods required to achieve the prescribed level
- Any exceptions or individual preferences that affect texture preparation

**Positioning and assistance**:
- Required seating position (angle of tilt, head position, foot support)
- Level of staff assistance required (independent, supervised, assisted, fully dependent)
- Use of adapted utensils or equipment

**Warning signs and emergency response**:
- Known high-risk behaviours (eating too quickly, pocketing food, reduced cough reflex)
- Individual early warning signs of distress during meals
- Emergency response protocol if choking occurs

**Communication and consent**:
- Whether the resident has capacity to consent to their dietary management plan
- If capacity is impaired, who is the named decision-maker and what is the agreed best-interests decision
- Any expressed preferences regarding oral versus non-oral feeding that must be respected
...
This three-document update must be completed within 24 hours of the SLT communication. Delay beyond 24 hours creates a window of clinical risk. Understanding the [mechanism of dysphagia](/en/clinical/dysphagia-mechanism) — particularly how pharyngeal phase dysfunction can lead to silent aspiration without obvious distress signs — reinforces why this 24-hour window matters.

## Kitchen Documentation: The Often-Missing Link
...
- IDDSI level (food and fluids)
- Any allergen restrictions
- Texture preparation method (blended, commercially prepared, assembled)
- Serving temperature requirements
- Date the prescription was last updated
- Name of the clinical professional who authorised the current prescription
...
- Time and meal type
- IDDSI level served (with confirmation that it matched the prescription)
- Volume consumed (as a percentage of what was served)
- Coughing, throat-clearing or other signs of aspiration during or after the meal
- Positioning compliance
- Level of assistance provided
- Any incidents or concerns, no matter how minor

These records are the early warning system for clinical deterioration. A pattern of increasing coughing frequency, declining intake volume or changes in voice quality post-meal should trigger an urgent SLT review — not simply a note in the file. Integrating these patterns into the [malnutrition screening](/en/nutrition/malnutrition-screening) review ensures that nutritional risk is not considered in isolation from swallowing safety.
...
- Ensure dysphagia status is visible on the resident's homepage or dashboard (not just in a dedicated clinical tab)
- Configure alerts that trigger when IDDSI prescriptions have not been reviewed within a specified period
- Implement a direct notification pathway from SLT to kitchen module that does not require manual transcription
...
The [care home audit checklist](/en/operations/audit-checklist-care-home) provides a monthly self-audit tool that can identify documentation gaps before an inspection. At minimum, a quarterly documentation audit should verify:

- All residents with dysphagia have a current IDDSI prescription (reviewed within the last 12 months, or sooner if clinical status has changed)
- Kitchen records match care plan prescriptions for every resident
- Mealtime observation records are completed and reviewed regularly
- Incidents have been documented with root cause analysis completed
...
- SLT recommendation not transferred to kitchen records
- Care plan not updated after hospital discharge when texture prescription changed
- Mealtime observation records not triggering a review despite documented concern signals
- Locum or agency staff not reading the care plan before assisting at mealtimes
