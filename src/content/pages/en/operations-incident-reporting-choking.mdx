---
title: "Choking Incident Reporting and Root Cause Analysis in Care Settings"
description: "A step-by-step guide for care home managers on documenting choking incidents, conducting root cause analysis and implementing systemic improvements to prevent recurrence."
lang: en
...
1. **Resident profile**: Diagnosis, current IDDSI level prescription, date of most recent SLT assessment
2. **Environmental factors**: Room layout, staffing ratio at mealtime, noise/distraction level, lighting
3. **Food/fluid factors**: IDDSI level actually served, method of preparation, whether thickener was correctly mixed, visual inspection result
4. **Human factors**: Whether the member of staff delivering the meal had completed IDDSI training, their familiarity with this resident's needs
5. **Care plan review**: Was the resident's current care plan accessible? Was the prescribed texture clearly documented and communicated to kitchen staff?
6. **Immediate outcome**: Clinical status, whether emergency services were called, hospital transfer

Many care homes use incident report templates that do not capture IDDSI-specific information. Review your templates against the [care home audit checklist](/en/operations/audit-checklist-care-home) to ensure dysphagia-specific fields are included.
...
Understanding the [mechanism of dysphagia](/en/clinical/dysphagia-mechanism) helps both managers and frontline staff appreciate why texture prescription adherence is a clinical safety issue, not merely a catering preference. Residents whose dysphagia affects the pharyngeal phase may have only seconds between an inappropriately-textured bolus entering their pharynx and a choking event occurring.
...
The ultimate goal of incident reporting is prevention. Monthly [safety audits](/en/operations/audit-checklist-care-home) should include a review of all dysphagia-related incidents from the preceding month. Trends — a cluster of incidents at a specific mealtime, with a particular staff member, or following a specific product change — provide early warning signals that can be addressed before a serious harm event occurs.
